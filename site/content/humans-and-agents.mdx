---
title: DSDS for humans and agents
slug: humans-and-agents
description: "A DSDS document serves two readers — people and AI agents. How documentBlocks and agentDocumentBlocks split the work between them."
---
...
- **Telling look-alikes apart.** Notes that stop an agent from confusing this with a similar entity (for example, "use a link to navigate, not this button").
- **Limits backed by proof.** A rule with evidence from testing (for example, "agents broke the touch target 9 times out of 10 when they shrank the height — don't").
