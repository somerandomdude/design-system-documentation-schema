---
title: "Migration — DSDS {{VERSION}}"
slug: migration
description: "How to move DSDS documents between spec versions: the 0.14.0 field-by-field mapping, the scripts that automate it, and the cases that need a human decision."
---
