...
```json
{
  "$schema": "https://designsystemdocspec.org/v0.15.0/dsds.bundled.schema.json",
  "dsdsVersion": "0.15.0",
  "entity": {
    "kind": "token",
