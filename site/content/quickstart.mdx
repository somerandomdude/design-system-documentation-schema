...
| guide | `"guide"` | A long-form, reading-oriented document — getting-started, contribution, tutorial, migration. It carries narrative sections and step-by-step procedures. |
