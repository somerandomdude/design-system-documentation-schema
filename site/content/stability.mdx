...
DSDS {{VERSION}} is a **pre-1.0 draft**. This page is the contract around that status: what can change and how you will be told, what will never change, the record of the executed breaking window, and the conditions under which 1.0 is declared. The goal is that an adopter can read this page and price the risk of adopting now.
