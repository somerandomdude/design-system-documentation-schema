...
This standard structures design system documentation in an interoperable format. It currently covers [components](/entities-component), [design tokens](/entities-token), [themes](/entities-theme), [foundations](/entities-foundation), and [patterns](/entities-pattern). Its goal is to act as a design system's single source of truth to feed documentation, train agents, and populate all system touchpoints.
