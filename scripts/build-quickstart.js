...
<section id="what">
  ...
  <p class="lead">DSDS (Design System Documentation Spec) is a JSON-based format for documenting design systems. It gives every piece of documentation — components, tokens, themes, styles, patterns — a predictable, machine-readable structure.</p>
  ...
  <div class="callout">
    ...
    <ol style="margin:8px 0 0;padding-left:20px">
      ...
      <li>Validate with <ds-code inline>npm run validate</ds-code> to catch structural errors early</li>
        ...
        <ds-footer>
          <p>Design System Documentation Spec (DSDS) 0.1 — Quick Start Guide</p>
